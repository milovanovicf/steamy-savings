...
It features a Search option to help users find their favourite game faster, using [Debounce](https://lodash.com/docs/4.17.15#debounce) from Lodash to prevent sending unnecessary to the API.
...
Users are able to explore many pages of latest games with discounts.
